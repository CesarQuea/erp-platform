...
from app.api.contracts import COMMON_ERROR_RESPONSES, SYSTEM_ERROR_RESPONSES
...
api_v1_router.include_router(system_router, responses=SYSTEM_ERROR_RESPONSES)
