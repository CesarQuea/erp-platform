...
def test_tenant_migration_chain_extends_o4_with_p5_without_branching() -> None:
    scripts = _scripts()
    assert scripts.get_current_head() == "0005_p5_module_activation"
    ...
    assert scripts.get_heads() == ["0005_p5_module_activation"]
